  ...
  (least-squares-iterate
   ...
   measurements (lambda (state update)
                  ...
                  (if (> (first state) 1.6)
                      (set-car! state 1.6))
                  (if (< (second state) -1.6)
                      (set-car! (cdr state) -1.6))
                  (if (> (second state) 1.6)
                      (set-car! (cdr state) 1.6))
                  (if (< (third state) -1.6)
                      (set-car! (cddr state) -1.6))
                  (if (> (third state) 1.6)
                      (set-car! (cddr state) 1.6))
                  (if (< (fourth state) .4)
                      (set-car! (cdddr state) .4))
                  (if (> (fourth state) 1.6)
                      (set-car! (cdddr state) 1.6))
                  (if (< (fifth state) .4)
                      (set-car! (cdddr (cdr state)) .4))
                  (if (> (fifth state) 1.6)
                      (set-car! (cdddr (cdr state)) 1.6))
                  (if (< (sixth state) .4)
                      (set-car! (cdddr (cddr state)) .4))
                  (if (> (sixth state) 1.6)
                      (set-car! (cdddr (cddr state)) 1.6))
                  #f)
   20))
